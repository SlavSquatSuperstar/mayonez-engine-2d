...
internal class GJKTest {
    ...
    fun getCirclesSimplex() {
        ...
        Assertions.assertNotNull(gjk.getSimplex(c1, c2))
        Assertions.assertNull(gjk.getSimplex(c1, c3))
    ...
    fun getRectanglesSimplex() {
        ...
        Assertions.assertNotNull(gjk.getSimplex(r1, r2))
        Assertions.assertNull(gjk.getSimplex(r1, r3))
    ...
    fun getEllipsesSimplex() {
        ...
        Assertions.assertNotNull(gjk.getSimplex(e1, e2))
        Assertions.assertNull(gjk.getSimplex(e1, e3))
    ...
    fun getPolygonsSimplex() {
        ...
        Assertions.assertNotNull(simplex)
        ...
        Assertions.assertTrue(simplexPoly.contains(Vec2(0f, 0f)))
    }

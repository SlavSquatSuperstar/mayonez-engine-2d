...
class RigidbodyTest {
    ...
    @Test
    void appliedForceChangesVelocity() {
    ...
    @Test
    void appliedTorqueChangesAngVelocity() {
        var rb = new Rigidbody(2);
    ...
    @Test
    void pointVelocityScalesWithRadius() {
    ...
    @Test
    void pointVelocityAddsWithLinearVelocity() {
        var rb = new Rigidbody(1, 0, 0);

...
class PolygonColliderTest {
    ...
    @Test
    void polygonVerticesReturnsWorld() {
    ...
    @Test
    void translatedPolygonVerticesReturnsWorld() {
    ...
    @Test
    void scaledPolygonVerticesReturnsWorld() {
    ...
    @Test
    void rotatedPolygonVerticesReturnsWorld() {

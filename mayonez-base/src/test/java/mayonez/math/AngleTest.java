...
class AngleTest {
    ...
    void angleRotationCorrect() {
        var ang = Angle.createDegrees(0f); // 90º = π/2
        float f = (float) (1.0 / Math.sqrt(2.0)); // √2/2 = 1/√2

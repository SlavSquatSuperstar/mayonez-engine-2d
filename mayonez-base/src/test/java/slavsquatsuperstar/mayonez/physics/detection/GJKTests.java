...
public class GJKTests {
    ...
    public void getRectanglesSimplex() {
        ...
        Rectangle r2 = new Rectangle(new Vec2(5.5f, 5.5f), new Vec2(5, 5), 45);
        Rectangle r3 = new Rectangle(new Vec2(6, 6), new Vec2(5, 5), 45);
    ...
    @Test
    public void getPenetrationCorrect() {
        assertNotNull(new GJKDetector().getPenetration(p1, p2));
    }

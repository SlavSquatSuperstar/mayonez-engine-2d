...
import mayonez.math.*
import mayonez.math.shapes.PolygonVertices.getMinCoordsPointIdx

/**
 * Contains methods for generating convex hulls from polygon vertices.
 *
...
object ConvexHull {
    ...
    fun orderedConvexHull(vertices: Array<Vec2>): Array<Vec2> {
        ...
        if (size < PolygonVertices.MIN_VERTICES) return vertices.copyOf()

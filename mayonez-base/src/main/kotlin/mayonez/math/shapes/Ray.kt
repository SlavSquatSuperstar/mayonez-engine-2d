...
class Ray(
    ...
    /**
     * The direction of the ray, v. The direction also determines the "length"
     * of the ray, or how far along the ray each step travels.
     */
    val direction: Vec2 = direction.unit()

    /**
     * Constructs a ray from an [Edge] object, using the starting point as the
     * origin and keeping the segment's direction and length.
     */
    ...
    /**
     * Calculates the distance from a point to the plane (infinite line)
     * represented by this ray.
     *
     * @param point a point in space
     * @return The perpendicular distance from the point to this ray, which
     *     will be positive if to the left, negative if to the right, and zero
     *     if on this ray.
     */
    ...
    /**
     * Calculates the point of intersection between the infinite lines
     * represented by this ray and another.
     *
    ...
    /**
     * Moves this ray's origin along the given vector while preserving its
    ...
    /**
     * Stretches this ray by the given scale factor. Only changes the length of
     * the ray if normalized is set to false.
     *

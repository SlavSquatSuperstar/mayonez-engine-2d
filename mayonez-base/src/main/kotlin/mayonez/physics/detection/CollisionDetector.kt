...
/**
 * Detects whether two shapes are intersecting and calculates the penetration vector if they are. Checking for
 * intersections is the first step in collision detection, and solving for the overlap is the second.
 *
...
//abstract class CollisionDetector(protected val shape1: Shape?, protected val shape2: Shape?) {
    ...
    /**
     * Calculates the minimum penetration direction and depth between two shapes if they are colliding.
     *
     * @param shape1 the first shape
     * @param shape2 the second shape

...
//    private Triangle tri = new Triangle(new Vec2(0, 0), new Vec2(10, 15), new Vec2(20, 0)).translate(new Vec2(82, 42));
    ...
    protected void onUserRender(Graphics2D g2) {
        ...
        boolean colliding = Collisions.checkCollision(rect, newTri);
        ...
        Collisions.getContacts(rect, newTri);
...
//        Collisions.getCollisionInfo(rect, tri);
//        DebugDraw.drawShape(rect, Colors.BLUE);
//        DebugDraw.drawShape(tri, Colors.LIGHT_GREEN);
    }

...
public class Player extends GameObject {
    ...
    protected void init() {
        ...
        SpriteSheet layer1 = new SpriteSheet("textures/player/layer1.png", tileSize, tileSize, 2, 13, 13 * 5);
        SpriteSheet layer2 = new SpriteSheet("textures/player/layer2.png", tileSize, tileSize, 2, 13, 13 * 5);
        SpriteSheet layer3 = new SpriteSheet("textures/player/layer3.png", tileSize, tileSize, 2, 13, 13 * 5);

...
public class TextFileTests {
    ...
    public void readLocalTextFile() {
        String[] properties = new TextFile("src/test/resources/testassets/properties.txt", AssetType.LOCAL).readLines();
        System.out.println(Arrays.toString(properties));
        assertEquals("Mayonez Engine", properties[0].split("=")[1]);
    }
    ...
    public void writeLocalTextFile() {
        TextFile textFile = new TextFile("src/test/resources/testassets/foobar/foobar.txt", AssetType.OUTPUT);
